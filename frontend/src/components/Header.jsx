...
import { redirectToCart, setCartQuantity, setRedirectSearch, setSearchText } from '../store/actions';

function Header() {
    const { textSearch } = useSelector(state => state.catalog);
    const { quantity, redirectt } = useSelector(state => state.cart);
    ...
    return (
        <header className="container">
            {textSearch.redirect ? redirect('/catalog') : null}
            {redirectt ? redirect('/cart') : null}
            <div className="row">
                <div className="col">
